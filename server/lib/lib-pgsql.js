...
types.setTypeParser(1114, (str) =>
  moment.tz(str, 'YYYY-MM-DD HH:mm:ss', 'Asia/Kuala_Lumpur').format('YYYY-MM-DD HH:mm:ss')
);
...
Object.defineProperty(pgSql, 'SQL_LEFTJ', { get: function () { return 'LEFT JOIN'; } });
Object.defineProperty(pgSql, 'SQL_ON', { get: function () { return 'ON'; } });
...
// Table
Object.defineProperty(pgSql, 'COMPANY_PROFILE', { get: function() { return 'tb_co'; }});
Object.defineProperty(pgSql, 'USER_GROUP', { get: function() { return 'tb_user_group'; }});
Object.defineProperty(pgSql, 'USER', { get: function() { return 'tb_user'; }});
